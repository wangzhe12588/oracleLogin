...
function SelectMirror(){
  ...
  MirrorBackup=(["Debian0"]="" ["Debian1"]="http://deb.debian.org/debian" ["Debian2"]="http://archive.debian.org/debian" ["Ubuntu0"]="" ["Ubuntu1"]="http://archive.ubuntu.com/ubuntu" ["CentOS0"]="" ["CentOS1"]="http://mirror.cezntos.org/centos" ["CentOS2"]="http://vault.centos.org")
...
[[ "$ddMode" == '1' ]] && {
  export SSL_SUPPORT='https://github.com/wangzhe12588/oracleLogin/raw/master/wget_udeb_amd64.tar.gz';
  if [[ -n "$tmpURL" ]]; then
    DDURL="$tmpURL"
